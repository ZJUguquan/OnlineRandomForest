...
#'        i.e., the **data** argument in \code{\link[randomForest]{randomForest::randomForest()}} function.
#'     }
#'   }
#'   \item{\code{predict(x)}}{
...
#' 
#' @details Online Random Forest was first introduced by \href{http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.150.1671&rep=rep1&type=pdf}{Amir Saffari}. 
